  ...
  return (
    <>
      <ToastContainer 
        ...
        transition={Bounce}
    />
      <div className='min-h-screen mt-20 bg-[#f2f2f2]/50'>
          <div className="searchBar flex justify-center">
              <div className="searchBarAndButton my-3 flex items-center relative">
                  <input type="search" onChange={(e:React.ChangeEvent<HTMLInputElement>) => setQueryParam(e.target.value)} value={queryParam} name="searchBar" id="searchBar" className="min-[0px]:max-md:w-[95%] w-88 h-10 rounded-full p-2 outline-2 outline-[#78ff78] placeholder:text-xs" placeholder='Search by class id, name or description of the class room'/>
