...
const Footer = () => {
  return (
    <footer className="relative w-full mb-5 mt-8">
      <div className="w-full px-8 mx-auto max-w-7xl">
        <div className="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
          <h5 className="mb-2 text-5xl font-semibold hover:text-[#5cf25c] transition-colors duration-700 text-slate-800 tracking-wide">
            Camly
          </h5>
        ...
        <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
          <p className="block mb-2 text-sm text-center text-slate-500 md:mb-0">
            Copyright © 2025
            <NavLink to="#" className='text-[#339633]'>Camly</NavLink>. All
            Rights Reserved.
          </p>
          <div className="flex gap-4 text-slate-600 sm:justify-center">
            <NavLink to="#" className="block transition-opacity text-inherit hover:text-[#5cf25c]">
